...
{
    public class IndirectFeeDeductionFailedSender : IIndirectFeeDeductionFailedSender
    {
        ...
        public EmailType[] EmailTypes
        {
            get
            {
                return new EmailType[] { 
                    EmailType.Preauthorization_IndirectFeeDeduction_Failed
            };
            }
        }

        public IndirectFeeDeductionFailedSender()
        {
