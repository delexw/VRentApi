...
{
    public class PreauthCompletionSuccessSender : IPreauthCompletionSuccessSender
    {
        ...
        {
            get { return new EmailType[] { EmailType.Preauthorization_PreauthComplete_Successful }; }
        }

        public PreauthCompletionSuccessSender()
        {
            if (Validation == null)
            {
