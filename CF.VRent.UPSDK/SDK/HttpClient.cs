        ...
        public int Send(Dictionary<string, string> sParaTemp, Encoding encoder)
        {
           // System.Net.ServicePointManager.Expect100Continue = false;
            ...
            try
            {
                ...
                //Proxy or not
                if (!String.IsNullOrWhiteSpace(SDKConfig.ProxyAddress))
                {
                    WebProxy px = new WebProxy(SDKConfig.ProxyAddress, true);
                    px.Credentials = new NetworkCredential(SDKConfig.ProxyCredentialUserName, SDKConfig.ProxyCredentialPassword);
