        ...
        public virtual void TryCatchWrapper(Action function)
        {
            ...
            catch (FaultException fe)
            {
                ...
                if (type.Length == 1)
                {
                    ...
                    LogInfor.WriteError("Schedule Job Info - " + this.GetType().Name, message, "Schedule Job");
                }
            }
            catch (Exception ex)
            {
                LogInfor.WriteError("Schedule Job Info - " + this.GetType().Name, ex.ToString(), "Schedule Job");
                throw ex;
            }
        }
